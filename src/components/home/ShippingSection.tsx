    ...
    <section id="shipping" ref={ref} className="py-16 md:py-24 bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-foreground mb-4">Shipping Information 📦</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            We pack with love and care! Every plant is carefully wrapped to ensure it arrives at your door healthy and
            happy. Here are our shipping options:
          </p>
        </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span
                        className={cn("font-serif font-bold", option.highlight ? "text-primary" : "text-foreground")}
                      >
                        {option.price}
                      </span>
                    </div>
        ...
        >
          <p className="text-lg text-muted-foreground">
            🌱 <span className="font-medium text-foreground">We pack with care!</span> Each plant is individually
            wrapped and secured to survive the journey to your home.
          </p>
        </div>
      </div>
    </section>
