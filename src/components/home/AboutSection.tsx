...
export function AboutSection() {
  ...
  return <section id="about" ref={ref} className="py-16 md:py-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          {/* Content */}
          <div className={cn('transition-all duration-700 delay-200', isInView ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8')}>
            ...
            <div className="mt-8">
              ...
              <div className="flex flex-wrap gap-3">
                {badges.map((badge, index) => <div key={badge.label} className={cn('flex items-center gap-2 bg-muted px-3 py-2 rounded-full transition-all duration-500', isInView ? 'opacity-100 scale-100' : 'opacity-0 scale-95')} style={{
