        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="aspect-[4/5] rounded-2xl overflow-hidden">
              <img
                ...
                src="/lovable-uploads/4cf4111b-2adf-4517-a7cd-775d21530f37.webp"
              />
            </div>
            {/* Decorative element */}
          ...
          >
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                Hey there, plant lovers! I'm Eva, the passionate plant parent behind Whattheficusthat. What started as a
                love for houseplants has grown into a licensed nursery dedicated to bringing you the most stunning rare
                and exotic plants.
              </p>
              <p>
                I personally select and care for each plant before it makes its way to your home. From Anthurium allure
                to Begonia bliss, I've got the green goods you're looking for!
              </p>
              <p>
                Join me on PalmStreet for live sales every week, where you can see the plants up close and ask all your
                plant care questions. Let's grow together! 🌿
              </p>
            </div>
